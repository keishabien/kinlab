...
content is wrapper in a main tag and a div with container class -->
    ...
    <div class="row orange mission_buttons">
        <div class="four columns"> <i class="fa fa-map fa-5x"></i><br><br><h3>read about the process</h3><br>
            <a href="clients.php"><button class="kinlab-button"> learn more </button></a>
        </div>
        <div class="four columns"> <i class="fa fa-calendar-check-o fa-5x"></i><br><br><h3>meet our doctors</h3>
            <br>
            <a href="staff.php"><button class="kinlab-button"> profiles </button></a>
        </div>
        <div class="four columns"> <i class="fa fa-hospital-o  fa-5x"></i><br><br><h3>visit our facility</h3><br>
            <a href="contact.php"><button class="kinlab-button"> location </button></a>
        </div>
    </div>
<div class="row" >
